...
const noiDungUuDaiRoute = require("./routes/noiDungUuDaiRoute");
const LoaiSPRoute = require("./routes/loaiSPRoute");
...
const routes = [
  ...
  { path: '/api/noidunguudai', router: noiDungUuDaiRoute },
  { path: '/api/theloailongnhau', router: LoaiSPRoute },
